...
```bash
    ...
    node scripts/mint.js --name AdministeredNFT --contract 0x8372bd3394E5222376339155E043Cb958a0129EE --metadata QmSdnyBWHJ2y9cDLHi6mWyX2ND77KnvURckQHsC7SpdS8U --public $ACCOUNT_2_PUBLIC --private $ACCOUNT_2_PRIVATE
...
Contract Path: ../artifacts/contracts/AdministeredNFT.sol/AdministeredNFT.json
...
```bash
    ...
    node scripts/add_administered.js --name AdministeredNFT --contract 0x8372bd3394E5222376339155E043Cb958a0129EE --public $ACCOUNT_1_PUBLIC --private $ACCOUNT_1_PRIVATE --add $ACCOUNT_2_PUBLIC --role USER
...
```bash
    ...
    node scripts/see_balance_administered.js --name AdministeredNFT --contract 0x8372bd3394E5222376339155E043Cb958a0129EE --public $ACCOUNT_2_PUBLIC --private $ACCOUNT_2_PRIVATE --owner $ACCOUNT_1_PUBLIC
...
```bash
    ...
    node scripts/remove_user_administered.js --name AdministeredNFT --contract 0x8372bd3394E5222376339155E043Cb958a0129EE --public $ACCOUNT_1_PUBLIC --private $ACCOUNT_1_PRIVATE --account $ACCOUNT_2_PUBLIC
